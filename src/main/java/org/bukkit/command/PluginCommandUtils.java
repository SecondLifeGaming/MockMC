...
/**
 * This utility class allows us to create a {@link PluginCommand}. The
 * constructor is marked as protected hence why this is in this exact package.
 */
public final class PluginCommandUtils
{
	 ...
	 *
	 * @param name
	 *            The name of the command to instantiate.
	 * @param owner
