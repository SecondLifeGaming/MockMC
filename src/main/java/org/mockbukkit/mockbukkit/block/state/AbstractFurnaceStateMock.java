...
import org.mockbukkit.mockbukkit.generated.org.bukkit.block.FurnaceBaseMock;
...
public abstract class AbstractFurnaceStateMock extends ContainerStateMock implements Furnace, FurnaceBaseMock
{
	...
	/**
	 * Constructs a new {@link AbstractFurnaceStateMock} for the provided
	 * {@link Material}. Only supports {@link Material#SMOKER},
	 * {@link Material#FURNACE}, and {@link Material#BLAST_FURNACE}.
	 *
	 * @param material
	...
	/**
	 * Constructs a new {@link AbstractFurnaceStateMock} for the provided
	 * {@link Block}. Only supports {@link Material#SMOKER},
	 * {@link Material#FURNACE}, and {@link Material#BLAST_FURNACE}.
	 *
	 * @param block
	...
	/**
	 * Constructs a new {@link AbstractFurnaceStateMock} by cloning the data from an
	 * existing one.
	 *
	 * @param state
	 *            The state to clone.
	...
	public boolean equals(Object o)
	{
		...
		return burnTime == that.burnTime && cookTime == that.cookTime && cookTimeTotal == that.cookTimeTotal
	...
	{
		return super.toStringInternal() + ", burnTime=" + burnTime + ", cookTime=" + cookTime + ", cookTimeTotal="
				+ cookTimeTotal + ", cookSpeedMultiplier=" + cookSpeedMultiplier;
	}
}
