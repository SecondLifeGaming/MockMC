...
public class SculkShriekerStateMock extends TileStateMock
		implements
			SculkShrieker,
			org.mockbukkit.mockbukkit.generated.org.bukkit.block.SculkShriekerBaseMock
{

	private int warningLevel;

	/**
	 * Constructs a new {@link SculkShriekerStateMock} for the provided
	 * {@link Material}. Only supports {@link Material#SCULK_SHRIEKER}
	 *
	 * @param material
	...
	/**
	 * Constructs a new {@link SculkShriekerStateMock} for the provided
	 * {@link Block}. Only supports {@link Material#SCULK_SHRIEKER}
	 *
	 * @param block
	...
	/**
	 * Constructs a new {@link SculkShriekerStateMock} by cloning the data from an
	 * existing one.
	 *
	 * @param state
	 *            The state to clone.
	...
	@Override
	@NotNull
	public SculkShriekerStateMock getSnapshot()
	{
	...
	@Override
	@NotNull
	public SculkShriekerStateMock copy()
	{
		return new SculkShriekerStateMock(this);
	}
