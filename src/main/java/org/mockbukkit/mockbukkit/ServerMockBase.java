...
import org.mockbukkit.mockbukkit.inventory.InventoryFactoryMock;
...
public abstract class ServerMockBase extends Server.Spigot
		implements
			org.mockbukkit.mockbukkit.generated.org.bukkit.ServerBaseMock
{
	...
	public <T extends BanList<?>> T getBanList(@NotNull BanList.Type type)
	{
		...
		return switch (type)
		{
			case IP -> (T) this.playerList.getIPBans();
			case PROFILE, NAME -> (T) this.playerList.getProfileBans();
		};
	}
