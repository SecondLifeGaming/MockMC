 ...
 * {@link MockBukkitInject} annotation. When {@code name} is provided and not
 * empty, it will be used as the exact name for the mock object. When
 * {@code name} is not provided or is an empty string, auto-generated names with
 * incrementing counters will be used (Player0, Player1, World0, World1,
 * Plugin0, Plugin1, etc.).
 * </p>
 *
 * <p>
 ...
 *
 * 		&#64;Test
 * 		void aUnitTest(&#64;MockBukkitInject ServerMock serverMock, &#64;MockBukkitInject(name = "admin") Player player,
			...
			TestExecutionExceptionHandler
{
	...
	{
		MockBukkit.unmock();
		MockBukkit.mock(); // Ensure a mock is always available between test runs. Note that after all
