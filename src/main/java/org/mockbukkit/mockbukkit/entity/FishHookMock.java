...
public class FishHookMock extends ProjectileMock
		implements
			FishHook,
			org.mockbukkit.mockbukkit.generated.org.bukkit.entity.FishHookBaseMock
{
	...
	/**
	 * Constructs a new {@link FishHookMock} on the provided {@link ServerMock} with
	...
	/**
	 * Updates the {@link HookState} of the hook. Normally the server does this
	 * every tick.
	 *
	 * @see #getState()
	 */
