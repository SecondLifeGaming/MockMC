...
public class StriderMock extends AnimalsMock
		implements
			Strider,
			org.mockbukkit.mockbukkit.generated.org.bukkit.entity.StriderBaseMock
{

	private static final NamespacedKey SUFFOCATING_MODIFIER_ID = NamespacedKey.minecraft("suffocating");

	private static final AttributeModifier SUFFOCATING_MODIFIER = new AttributeModifier(SUFFOCATING_MODIFIER_ID,
			-0.3400000035762787D, AttributeModifier.Operation.ADD_NUMBER);
	...
	/**
	 * Constructs a new {@link Strider} on the provided {@link ServerMock} with a
	 * specified {@link UUID}.
	 *
	 * @param server
