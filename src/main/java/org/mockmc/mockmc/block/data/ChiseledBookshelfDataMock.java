...
public class ChiseledBookshelfDataMock extends BlockDataMock implements ChiseledBookshelf {
    ...
    /**
     * Updated: Accept ChiseledBookshelfDataMock specifically.
     * This ensures that if this class ever adds specific fields (not in BlockDataKey),
     * you can actually access them from 'other'.
     */
    ...
    /**
     * Constructor-based clone satisfies the Bukkit API while
     * following modern Java safety standards.
     */
    @Override
