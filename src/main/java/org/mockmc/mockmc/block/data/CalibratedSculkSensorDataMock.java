...
public class CalibratedSculkSensorDataMock extends SculkSensorDataMock implements CalibratedSculkSensor
{
	...
	/**
	 * This is your Copy Constructor. The linter prefers this over the clone()
	 * mechanism.
	 */
	...
	/**
	 * If the linter still warns about the 'clone' implementation, it is because it
	 * wants you to use the constructor directly. We keep this ONLY because the
	 * Bukkit API requires it.
	 */
	@Override
	@SuppressWarnings(
	{"squid:S2975", "java:S1182"}) // Suppress: "clone" should be replaced by copy constructor
