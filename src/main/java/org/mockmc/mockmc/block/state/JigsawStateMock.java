...
public class JigsawStateMock extends TileStateMock implements Jigsaw
{
	...
	/**
	 * Constructs a new {@link JigsawStateMock} for the provided {@link Block}. Only
	 * supports {@link Material#JIGSAW}
	 *
	 * @param block
	...
	/**
	 * Constructs a new {@link JigsawStateMock} by cloning the data from an existing
	 * one.
	 *
	 * @param state
	 *            The state to clone.
