...
public class ProfileBanListMock implements ProfileBanList
{
	...
	// Accesses to this field must be done while synchronizing on
	// ProfileBanListMock.this
			...
			@Nullable String source)
	{
		...
		return (E) new MockMCProfileBanEntry(Bukkit.createPlayerProfile(profile.getUniqueId(), profile.getName()),
			...
			@Nullable Date expires, @Nullable String source)
	{
		...
		final BanEntry<PlayerProfile> entry = new PaperProfileBanEntryMock(target,
