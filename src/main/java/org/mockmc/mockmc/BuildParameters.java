...
public class BuildParameters
{
	...
	static
	{
		try (InputStream is = BuildParameters.class.getResourceAsStream("/mockmc-build.properties"))
		{
			if (is != null)
			{
				PROPERTIES.load(is);
	...
	/**
	 * The version of MockMC.
	 */
	public static final String MOCK_MC_VERSION = PROPERTIES.getProperty("mockMCVersion", UNKNOWN);
	/**
	 * The full version of the Paper API MockMC was built against.
	 */
