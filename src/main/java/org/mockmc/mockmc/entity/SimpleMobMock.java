 ...
 * {@link MobMock} when a specific type of entity is not required. This should
 * only be used for testing code that doesn't care what type of entity it is.
 *
 * @see MobMock
 */
public class SimpleMobMock extends MobMock
{
	...
	/**
	 * Constructs a new {@link SimpleMobMock} on the provided {@link ServerMock}
