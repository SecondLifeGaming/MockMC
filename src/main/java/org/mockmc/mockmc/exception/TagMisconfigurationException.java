...
/**
 * An {@link TagMisconfigurationException} is thrown whenever a {@link Tag}
...
public class TagMisconfigurationException extends Exception
{
	 ...
	 * {@link Tag}'s {@link NamespacedKey} with the provided context.
	 *
	 * @param key
	 *            The {@link NamespacedKey} of our {@link Tag}
	 * @param message
