...
import org.mockmc.mockmc.exception.PluginClassNotFoundException;
import java.io.File;
			...
			org.mockmc.mockmc.generated.io.papermc.paper.plugin.provider.classloader.ConfiguredPluginClassLoaderBaseMock
{
	...
	public MockMCConfiguredPluginClassLoader(ServerMock server, PluginDescriptionFile description, File dataFolder,
			File pluginFile)
	{
		super(new URL[0]);
		this.server = server;
