...
class MockMCURLClassLoaderTest
{

	@MockMCInject
	private ServerMock serverMock;
	private MockMCURLClassLoader urlClassLoader;
	...
	void setUp() throws IOException, InvalidDescriptionException
	{
		...
		this.urlClassLoader = new MockMCURLClassLoader(TEST_PLUGIN_FILE, getClass().getClassLoader(), serverMock,
	...
	{
		assertDoesNotThrow(() -> urlClassLoader.loadClass("org.mockmc.testplugin.TestPlugin"));
	}
	...
	{
		assertDoesNotThrow(() -> urlClassLoader.loadClass("org.mockmc.mockmc.MockMC"));
	}
