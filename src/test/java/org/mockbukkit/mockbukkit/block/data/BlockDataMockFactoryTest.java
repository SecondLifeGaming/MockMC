...
class BlockDataMockFactoryTest
{
	...
	class Mock
	{
		...
		class Tags
		{
			...
			@ParameterizedTest
			@ValueSource(strings =
			{"BLACK_BED", "BLUE_BED", "BROWN_BED", "CYAN_BED", "GRAY_BED", "GREEN_BED", "LIGHT_BLUE_BED",
					"LIGHT_GRAY_BED", "LIME_BED", "MAGENTA_BED", "ORANGE_BED", "PINK_BED", "PURPLE_BED", "RED_BED",
			...
			@ParameterizedTest
			@ValueSource(strings =
			{"ACACIA_BUTTON", "BAMBOO_BUTTON", "BIRCH_BUTTON", "CHERRY_BUTTON", "CRIMSON_BUTTON", "DARK_OAK_BUTTON",
					"JUNGLE_BUTTON", "MANGROVE_BUTTON", "OAK_BUTTON", "PALE_OAK_BUTTON", "POLISHED_BLACKSTONE_BUTTON",
			...
			@ParameterizedTest
			@ValueSource(strings =
			{"BLACK_CANDLE", "BLUE_CANDLE", "BROWN_CANDLE", "CANDLE", "CYAN_CANDLE", "GRAY_CANDLE", "GREEN_CANDLE",
					"LIGHT_BLUE_CANDLE", "LIGHT_GRAY_CANDLE", "LIME_CANDLE", "MAGENTA_CANDLE", "ORANGE_CANDLE",
			...
			@ParameterizedTest
			@ValueSource(strings =
			{"ACACIA_DOOR", "BAMBOO_DOOR", "BIRCH_DOOR", "CHERRY_DOOR", "COPPER_DOOR", "CRIMSON_DOOR", "DARK_OAK_DOOR",
					"EXPOSED_COPPER_DOOR", "IRON_DOOR", "JUNGLE_DOOR", "MANGROVE_DOOR", "OAK_DOOR",
					"OXIDIZED_COPPER_DOOR", "PALE_OAK_DOOR", "SPRUCE_DOOR", "WARPED_DOOR", "WAXED_COPPER_DOOR",
			...
			{"ACACIA_FENCE", "BAMBOO_FENCE", "BIRCH_FENCE", "CHERRY_FENCE", "CRIMSON_FENCE", "DARK_OAK_FENCE",
					"JUNGLE_FENCE", "MANGROVE_FENCE", "NETHER_BRICK_FENCE", "OAK_FENCE", "PALE_OAK_FENCE",
					"SPRUCE_FENCE", "WARPED_FENCE",})
			...
			@ParameterizedTest
			@ValueSource(strings =
			{"ACACIA_FENCE_GATE", "BAMBOO_FENCE_GATE", "BIRCH_FENCE_GATE", "CHERRY_FENCE_GATE", "CRIMSON_FENCE_GATE",
					"DARK_OAK_FENCE_GATE", "JUNGLE_FENCE_GATE", "MANGROVE_FENCE_GATE", "OAK_FENCE_GATE",
					"PALE_OAK_FENCE_GATE", "SPRUCE_FENCE_GATE", "WARPED_FENCE_GATE",})
			...
			{"ACACIA_SLAB", "ANDESITE_SLAB", "BAMBOO_MOSAIC_SLAB", "BAMBOO_SLAB", "BIRCH_SLAB", "BLACKSTONE_SLAB",
					"BRICK_SLAB", "CHERRY_SLAB", "COBBLED_DEEPSLATE_SLAB", "COBBLESTONE_SLAB", "CRIMSON_SLAB",
					"CUT_COPPER_SLAB", "CUT_RED_SANDSTONE_SLAB", "CUT_SANDSTONE_SLAB", "DARK_OAK_SLAB",
					"DARK_PRISMARINE_SLAB", "DEEPSLATE_BRICK_SLAB", "DEEPSLATE_TILE_SLAB", "DIORITE_SLAB",
					"END_STONE_BRICK_SLAB", "EXPOSED_CUT_COPPER_SLAB", "GRANITE_SLAB", "JUNGLE_SLAB", "MANGROVE_SLAB",
					"MOSSY_COBBLESTONE_SLAB", "MOSSY_STONE_BRICK_SLAB", "MUD_BRICK_SLAB", "NETHER_BRICK_SLAB",
					"OAK_SLAB", "OXIDIZED_CUT_COPPER_SLAB", "PALE_OAK_SLAB", "PETRIFIED_OAK_SLAB",
			...
			@ParameterizedTest
			@ValueSource(strings =
			{"ACACIA_WALL_SIGN", "BAMBOO_WALL_SIGN", "BIRCH_WALL_SIGN", "CHERRY_WALL_SIGN", "CRIMSON_WALL_SIGN",
					"DARK_OAK_WALL_SIGN", "JUNGLE_WALL_SIGN", "MANGROVE_WALL_SIGN", "OAK_WALL_SIGN",
		...
		class ClassType
		{
			...
			@ParameterizedTest
			@ValueSource(strings =
			{"COMPOSTER", "LAVA", "POWDER_SNOW_CAULDRON", "WATER", "WATER_CAULDRON",})
			...
			@ParameterizedTest
			@ValueSource(strings =
			{"BLACK_CANDLE_CAKE", "BLUE_CANDLE_CAKE", "BROWN_CANDLE_CAKE", "CANDLE_CAKE", "CYAN_CANDLE_CAKE",
					"DEEPSLATE_REDSTONE_ORE", "GRAY_CANDLE_CAKE", "GREEN_CANDLE_CAKE", "LIGHT_BLUE_CANDLE_CAKE",
					"LIGHT_GRAY_CANDLE_CAKE", "LIME_CANDLE_CAKE", "MAGENTA_CANDLE_CAKE", "ORANGE_CANDLE_CAKE",
					"PINK_CANDLE_CAKE", "PURPLE_CANDLE_CAKE", "RED_CANDLE_CAKE", "REDSTONE_LAMP", "REDSTONE_ORE",
					"REDSTONE_TORCH", "WHITE_CANDLE_CAKE", "YELLOW_CANDLE_CAKE",})
			...
			@ParameterizedTest
			@ValueSource(strings =
			{"ACACIA_LOG", "ACACIA_WOOD", "BAMBOO_BLOCK", "BASALT", "BIRCH_LOG", "BIRCH_WOOD", "BONE_BLOCK",
					"CHERRY_LOG", "CHERRY_WOOD", "CRIMSON_HYPHAE", "CRIMSON_STEM", "DARK_OAK_LOG", "DARK_OAK_WOOD",
					"DEEPSLATE", "HAY_BLOCK", "INFESTED_DEEPSLATE", "JUNGLE_LOG", "JUNGLE_WOOD", "MANGROVE_LOG",
					"MANGROVE_WOOD", "MUDDY_MANGROVE_ROOTS", "NETHER_PORTAL", "OAK_LOG", "OAK_WOOD", "OCHRE_FROGLIGHT",
					"PALE_OAK_LOG", "PALE_OAK_WOOD", "PEARLESCENT_FROGLIGHT", "POLISHED_BASALT", "PURPUR_PILLAR",
					"QUARTZ_PILLAR", "SPRUCE_LOG", "SPRUCE_WOOD", "STRIPPED_ACACIA_LOG", "STRIPPED_ACACIA_WOOD",
			...
			@ValueSource(strings =
			{"ACACIA_BUTTON", "BAMBOO_BUTTON", "BIRCH_BUTTON", "CHERRY_BUTTON", "CRIMSON_BUTTON", "DARK_OAK_BUTTON",
					"JUNGLE_BUTTON", "LEVER", "MANGROVE_BUTTON", "OAK_BUTTON", "PALE_OAK_BUTTON",
